...
mooseImg0 = pygame.image.load("moose.png")
...
def start_screen():
    ...
    #Images
    mooseImg = pygame.image.load("moose.png")
...
#sound effects
bonk_sfx = pygame.mixer.Sound("bonk.wav")
whoosh_sfx = pygame.mixer.Sound("whoosh.wav")
rubber_duck_sfx = pygame.mixer.Sound("rubber_duck.wav")
boom_sfx = pygame.mixer.Sound("boom.wav")
beep_sfx = pygame.mixer.Sound("beep(1).wav")
beep2_sfx = pygame.mixer.Sound("beep2.wav")
heart_loss_sfx = pygame.mixer.Sound("losing_drums.wav")
...
while not done:
    ...
    if moose_kills >= 8 and gameover == False:
        mooseImg2 = pygame.image.load("moose.png")
    ...
    if moose_kills >= 16 and gameover == False:
        mooseImg3 = pygame.image.load("moose.png")
    ...
    if moose_kills >= 30 and gameover == False:
        mooseImg4 = pygame.image.load("moose.png")
